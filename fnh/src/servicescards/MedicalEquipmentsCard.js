...
import medequipimg from '../assets/cardimgs/medicalequip.png'

const MedicalEquipmentsCard = () => {
  return (
    ...
    fontSize: '1.5rem',
    fontWeight: 'bold', marginTop:'5px'}}>Medical Equipments</p>
    </div>
    </Link>
  )
}

export default MedicalEquipmentsCard